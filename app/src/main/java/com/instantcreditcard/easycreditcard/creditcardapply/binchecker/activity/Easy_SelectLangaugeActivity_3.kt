...
import com.instantcreditcard.easycreditcard.creditcardapply.binchecker.databinding.ActivitySelectLangaugeBinding

class Easy_SelectLangaugeActivity_3 : AppCompatActivity(), View.OnClickListener {
    lateinit var mBinding:ActivitySelectLangaugeBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        mBinding = ActivitySelectLangaugeBinding.inflate(layoutInflater)
    ...
    private fun nextActivity(view: View) {
            ...
            startActivity(
                Intent(this@Easy_SelectLangaugeActivity_3, Easy_SelectCardActivity_4::class.java)
            )
    }
}