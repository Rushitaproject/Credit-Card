package com.instantcreditcard.easycreditcard.creditcardapply.binchecker.DBHandler;
...
public class  DbHandler extends SQLiteOpenHelper {
    ...
    public ArrayList<HashMap<String, String>> GetUsers() {
        ...
        Cursor rawQuery = writableDatabase.rawQuery("SELECT id, name, location, designation FROM userdetails", (String[]) null);
        while (rawQuery.moveToNext()) {
            HashMap hashMap = new HashMap();
            hashMap.put(KEY_ID, String.valueOf(rawQuery.getInt(rawQuery.getColumnIndex(KEY_ID))));
