...
import com.instantcreditcard.easycreditcard.creditcardapply.binchecker.databinding.ActivityCsapplyCreditBinding


class Easy_CSApplyCreditActivity_21 : AppCompatActivity(), View.OnClickListener {
    private lateinit var mBinding: ActivityCsapplyCreditBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        mBinding = ActivityCsapplyCreditBinding.inflate(layoutInflater)
    ...
    private fun nextActivity(nextInt: Int) {
        when (nextInt) {
            1 -> {
                ...
                activityResultLauncher.launch(Intent(this, Easy_ApplySeconditActivity_22::class.java))
            }
        }
    }
