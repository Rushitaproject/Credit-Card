...
import com.instantcreditcard.easycreditcard.creditcardapply.binchecker.databinding.ActivityApplySeconditBinding



class Easy_ApplySeconditActivity_22 : AppCompatActivity(), View.OnClickListener {
    private lateinit var mBinding: ActivityApplySeconditBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        mBinding = ActivityApplySeconditBinding.inflate(layoutInflater)
    ...
    private fun nextActivity(nextInt:Int){
        when(nextInt){
            ...
            1->{
                ...
                activityResultLauncher.launch(Intent(this, Easy_ApplyThirdActivity_23::class.java))
